...
public class FileIo {
    public  static String folderPath="D://XMTest//";
    public static void write(List<SourceFile> list){
            ...
            File file=new File(folder,"XMTest.csv");
    ...
    public static  List<SourceFile> readCsv(String file){
